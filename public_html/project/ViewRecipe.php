...
function getRecipesFromSpoonacular($apiKey) {// Initialize cURL session
    $curl = curl_init();
    $db = getDB();
    // Set cURL options
    ...
    // Your implementation here, possibly similar to your fetchRecipesFromSpoonacular function
}
